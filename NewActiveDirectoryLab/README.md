...
**Screenshots:**
* `Lab.4` – The "Welcome to the Domain" popup *(coming soon)*
* `Lab.5` – MEL-CL-01 visible in Active Directory Users and Computers *(coming soon)*
...
**Screenshot:** `Lab.6` – ADUC sidebar showing the MelvinLab_users nested tree *(coming soon)*
...
**Screenshot:** `Lab.7` – Properties of a user showing populated Department and Job Title fields *(coming soon)*
...
**Screenshot:** `Lab.8` – The "Member Of" tab for ThomasA showing Domain Admins membership *(coming soon)*
...
**Screenshot:** `Lab.9` – The Members tab of GS_IT_Staff showing the IT users *(coming soon)*
...
**Screenshot:** `Lab.10` – The Local Administrators group properties on MEL-CL-01 showing GS_IT_Staff as a member *(coming soon)*
...
**Screenshot:** `Lab.11` – The Command Prompt output showing the active group memberships *(coming soon)*
